...
export class CSharpGenerator extends CodeGenerator {
  ...
  private generateStruct(struct: DeukPackStruct, ast: DeukPackAST, currentNamespace?: string): string[] {
    const lines: string[] = [];
  ...
  private getSchemaTypeInfo(type: any, ast: DeukPackAST, currentNamespace?: string): { type: string, typeName: string } {
    ...
    if (typeof type === 'string') {
      ...
      if (resolved?.kind === 'record') return { type: 'DpSchemaType.Struct', typeName: type };

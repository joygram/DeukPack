...
public class DpPackProtocol implements DpProtocol {
    ...
    public DpRecord readStructBegin() {
        if (++recursionDepth > MAX_RECURSION_DEPTH) throw new RuntimeException("Depth");
        PackTag tag = PackTag.findByValue(readRawByte());
    ...
    @Override
    public void readStructEnd() { recursionDepth--; }
    ...
    private String readRawString() {
        ...
        if (length < 0 || length > MAX_SAFE_LENGTH) throw new RuntimeException("Safe Len");
